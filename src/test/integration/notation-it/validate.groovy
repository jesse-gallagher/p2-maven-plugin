...
assert Util.symbolicName(jar) == "org.tinygroup.pageflowplugin;singleton:=true"

jarName = "org.tinygroup.pageflowplugin_0.0.8.jar"
jar = new Jar(new File(target, jarName));
assert Util.symbolicName(jar) == "org.tinygroup.pageflowplugin;singleton:=true"

jarName = "org.tinygroup.pageflowplugin.tests_0.0.9.jar"
jar = new Jar(new File(target, jarName));
assert Util.symbolicName(jar) == "org.tinygroup.pageflowplugin.tests;singleton:=true"
